...
const Navbar = () => {
  return (
    <nav id="home" className="flex flex-row items-center mx-auto max-w-[1200px]">
      {/* logo */}
      <div className="flex-[0.4] flex items-center gap-2 md:gap-3">
      ...
      <div className="flex-[0.6] md:flex md:items-center md:items-row md:justify-between">
        <div className="nav-links hidden md:flex md:flex-row md:items-center md:gap-5 md:text-[#f1f1f1] md:capitalize md:text-lg md:font-normal">
          ...
          <Link to="technology" smooth={true} duration={500} className="cursor-pointer">
            technologies
          </Link>
          ...
          <Link to="reviews" smooth={true} duration={500} className="cursor-pointer">
            reviews
          </Link>
